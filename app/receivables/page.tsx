  ...
  return (
    <div className="space-y-6">
      ...
      <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        ...
        <KpiCard hint="Сума без прострочення" title="Непрострочена" tone="secondary" value={money(sum(receivables.map((row) => row.currentDebt)))} />
      ...
      <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        ...
        <KpiCard title="11–20 днів" tone="secondary" value={money(bucket11To20)} />
